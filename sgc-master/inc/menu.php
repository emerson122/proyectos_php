...
<nav class="navbar navbar-inverse navbar-fixed-top" id="menu" role="navigation">
    <div class="container">
      ...
      <li class="dropdown">
        ...
        <li><a href="/prototipo/reporte_ventas.php">Generar Reporte</a></li>
        </ul>
      </li>
    ...
    <li class="dropdown">
      ...
      <ul class="dropdown-menu">
        <li><a href="producto_alta.php">Nuevo Producto</a></li>
        <li><a href="producto_consulta.php">Lista de Productos</a></li>
        </ul>
    </li>
      ...
      <ul class="dropdown-menu">
            ...
            <li><a href="/prototipo/caja_consulta.php">Consultar Movimientos</a></li>
      </ul>
    </li>
